...
"""  # DONE problems have DIFFICULTY and TIME ratings:
...
def run_test_problem1a():
    ...
    # Test 3
    expected = -1.670
    actual = problem1a(3, 10)
    print('Test 3 expected:', expected)
    print('       actual:  ', actual)

    # Test 4
    expected = -2.035
    actual = problem1a(4, 60)
...
def problem1c(n):
    ...
    for k in range(2, (n + 1)):
        if k <= n and is_prime(k) == True:
            count = k * count
    answer = sum_of_digits(count)
    return answer
